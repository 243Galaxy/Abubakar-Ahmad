...
$udate=date('d-m-Y h:i:s', time());;
	$sql="SELECT password FROM inmate_info where password=?";
	...
	if($row_cnt>0)
	{
		$con="update inmate_info set password=?,passUdateDate=?  where id=?";
...
<?php $result ="SELECT passUdateDate FROM inmate_info WHERE id=?";
